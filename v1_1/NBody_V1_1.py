...
from AstroObject_V1_1 import *
from Newton_V1_1 import *
from Ship_V1_1 import *
...
sun = AstroObject(mass = 100.0, density = 10.0, position = [0.0, 0.0, 0.0], velocity = [0.0, 0.0, 0.0], angular_position = 0.0, angular_velocity = 2.0, ambient = [1.0, 1.0, 0.0, 1.0], diffuse = [1.0, 1.0, 0.0, 1.0], specular = [1.0, 1.0, 0.0, 1.0], emissive = [0.0, 0.0, 0.0, 0.0], shininess = .5)
