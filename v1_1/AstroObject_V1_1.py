...
class AstroObject:
    ...
    def __init__(self, mass = 1.0, density = 1.0, position = [0.0, 0.0, 0.0], velocity = [0.0, 0.0, 0.0], angular_position = 0.0, angular_velocity = 2, ambient = [1.0, 1.0, 1.0, 1.0], diffuse = [1.0, 1.0, 1.0, 1.0], specular = [1.0, 1.0, 1.0, 1.0], emissive = [0.0, 0.0, 0.0, 0.0], shininess = .5, exists = True):
    ...
    def getEmissiveLight(self):
        """Returns the Emission of Light from the Astrological Object"""
        return self._em
    ...
    def setEmissiveLight(self, emissive):
        """Sets the Emission of Light from the Astrological Object"""
        self._em = emissive
